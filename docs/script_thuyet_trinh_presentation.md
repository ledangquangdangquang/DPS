...
Để đánh giá công bằng, đồ án triển khai bốn nhánh. SoCE trực tiếp là kênh tham chiếu. DPS chính xác chiếu tensor SoCE lên không gian con để kiểm chứng khả năng biểu diễn. DPS xấp xỉ 4D tính gần đúng hệ số ở cả bốn chiều. Hybrid DPS dùng DPS ở thời gian và tần số, còn phần anten được tính trực tiếp.

Các nhánh được so sánh theo hai chỉ tiêu: NMSE so với SoCE và thời gian chạy. Cần lưu ý rằng DPS chính xác vẫn cần tensor SoCE ban đầu, còn hai nhánh xấp xỉ hướng đến tránh bước này.
...
Vì vậy, nếu ưu tiên độ chính xác, DPS chính xác là lựa chọn phù hợp để biểu diễn. Nếu cần tránh tạo toàn bộ SoCE và chấp nhận sai số xấp xỉ nhỏ, hybrid là hướng triển khai thực tế hơn.
