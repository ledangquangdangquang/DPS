...
Tensor là sự mở rộng của vô hướng, vector và ma trận sang nhiều chiều. Trong đồ án, đáp ứng kênh được lưu dưới dạng tensor bốn chiều có kích thước $$M\times Q\times N_{\mathrm{Tx}}\times N_{\mathrm{Rx}}$$. Mỗi phần tử phức $$h_{m,q,s,r}$$ biểu diễn đáp ứng kênh tại một mẫu thời gian, một điểm tần số và một cặp anten phát--thu cụ thể. Trong MATLAB, tensor này được triển khai bằng một mảng số phức bốn chiều.

### 10. Tần số chuẩn hóa có ý nghĩa gì?
...
### 11. Vì sao dấu pha của chiều tần số và chiều thu là dấu âm?
...
### 12. Vì sao dùng mảng ULA và khoảng cách $$D_s/\lambda=0{,}5$$?
...
### 13. Vì sao kênh được xem là giới hạn băng?
...
### 15. Vì sao đồ án chọn DPS thay vì cơ sở DFT?
...
### 16. Trị riêng DPS có ý nghĩa gì?
...
### 18. Số chiều DPS được chọn như thế nào?
...
### 20. Tại sao gọi là “DPS chính xác” trong khi NMSE không bằng không?
...
### 21. Nhánh DPS chính xác có thật sự giảm độ phức tạp không?
...
### 22. Hệ số xấp xỉ DPS được tính như thế nào?
...
### 23. Hệ số phân giải $$r$$ có vai trò gì?
...
### 24. Vì sao cơ sở DPS bốn chiều có thể tách thành các cơ sở một chiều?
...
### 25. Khi nào DPS không còn lợi thế?
...
### 26. Bốn nhánh mô phỏng khác nhau như thế nào?
...
### 27. Vì sao cần nhánh DPS xấp xỉ 4D nếu kết quả kém hơn hybrid?
...
### 28. Vì sao hybrid phù hợp với cấu hình hiện tại?
...
### 30. Các MPC được sinh theo phân bố nào?
...
### 31. Vì sao chỉ số tần số chạy từ $$0$$ đến $$Q-1$$ thay vì lấy tâm tại không?
...
### 32. Cấu hình mô phỏng chính là gì?
...
### 33. NMSE là gì và vì sao dùng NMSE?
...
### 34. Kết quả NMSE chính là bao nhiêu?
...
### 35. Vì sao DPS xấp xỉ 4D có sai số lớn nhất?
...
### 36. Hình đáp ứng chỉ vẽ một cặp anten có đủ thuyết phục không?
...
### 37. Kết quả thời gian chạy là bao nhiêu?
...
### 38. So sánh thời gian hiện tại có công bằng không?
...
### 39. Tại sao số hệ số giảm khoảng 303 lần nhưng thời gian không giảm 303 lần?
...
### 40. Kết quả có chứng minh hybrid luôn tốt nhất không?
...
### 41. Đồ án đã tái tạo đúng hình hoặc bảng nào của bài báo chưa?
...
### 42. Vì sao chưa dùng mô hình kênh chuẩn như 3GPP?
...
### 43. Vì sao mô phỏng không có nhiễu?
...
### 44. Có thể khẳng định phương pháp đáp ứng thời gian thực không?
...
### 45. Nếu miền băng hoặc vận tốc tăng thì điều gì xảy ra?
...
### 46. Nếu số MPC tăng thì điều gì xảy ra?
...
### 47. Nếu số anten tăng thì hybrid còn tốt không?
...
### 48. Hạn chế lớn nhất của đồ án là gì?
...
### 49. Nếu có thêm thời gian, bước tiếp theo quan trọng nhất là gì?
...
### 58. Nếu DPS chính xác đã tái tạo kênh với NMSE rất nhỏ thì vì sao vẫn cần nghiên cứu DPS xấp xỉ 4D và hybrid?

DPS chính xác chủ yếu dùng để kiểm tra chất lượng của không gian con DPS đã chọn. Phương pháp này vẫn phải tạo các véc-tơ hàm mũ của từng MPC và chiếu chúng lên cơ sở DPS, nên bước tính hệ số vẫn có chi phí đáng kể khi kích thước hoặc số MPC tăng. DPS xấp xỉ 4D được nghiên cứu để ước lượng trực tiếp hệ số từ tần số chuẩn hóa, qua đó tránh các phép chiếu chính xác trên cả bốn chiều. Hybrid chỉ thực hiện xấp xỉ ở hai chiều thời gian--tần số và giữ hàm mũ trực tiếp ở hai chiều anten. Vì vậy, hai nhánh tiếp theo dùng để khảo sát khả năng giảm chi phí tính hệ số và sự đánh đổi giữa sai số với thời gian, không phải vì DPS chính xác thiếu độ chính xác.

### 59. Vì sao ở Hình 4.3 runtime của DPS xấp xỉ 4D lại cao hơn DPS chính xác?

Trong cấu hình hiện tại, DPS chính xác tạo các véc-tơ hàm mũ cho toàn bộ MPC rồi tính hệ số bằng các phép nhân ma trận đã được MATLAB tối ưu. DPS xấp xỉ 4D lại xử lý tuần tự từng MPC và đánh giá hàm sóng DPS riêng trên cả bốn chiều. Mỗi lần đánh giá còn phải ánh xạ tần số lên lưới độ phân giải cao, truy xuất giá trị DPS và hiệu chỉnh trị riêng, pha. Hai chiều anten chỉ có $$N_{\mathrm{Tx}}=N_{\mathrm{Rx}}=4$$ nên phép chiếu chính xác vốn đã rẻ; chi phí vòng lặp và tra cứu của phép xấp xỉ chưa được bù lại. Vì vậy, giảm số phép toán theo công thức không bảo đảm runtime thực tế luôn thấp hơn, đặc biệt khi cách hiện thực chưa được véc-tơ hóa hoặc kích thước bài toán còn nhỏ. Kết quả này cũng giải thích vì sao hybrid, chỉ xấp xỉ hai chiều lớn và giữ trực tiếp hai chiều anten ngắn, phù hợp hơn trong cấu hình đang xét.

### 60. Tại sao phải nhân Kronecker các véc-tơ hệ số của bốn chiều?

Đóng góp của một MPC có tính tách được theo bốn chiều: thời gian, tần số, anten phát và anten thu. Giá trị tại chỉ số $$(m,q,s,r)$$ bằng tích của bốn thành phần một chiều tương ứng. Vì vậy, sau khi biểu diễn mỗi thành phần trên cơ sở DPS, cần dùng tích tensor để ghép bốn véc-tơ hệ số một chiều thành một phần tử cơ sở hoặc tensor hệ số 4D. Nếu viết tensor dưới dạng véc-tơ, phép ghép này chính là tích Kronecker, chẳng hạn

$$
\boldsymbol{\gamma}^{(\mathrm{Rx})}_p
\otimes\boldsymbol{\gamma}^{(\mathrm{Tx})}_p
\otimes\boldsymbol{\gamma}^{(f)}_p
\otimes\boldsymbol{\gamma}^{(t)}_p,
$$

trong đó thứ tự có thể thay đổi tùy quy ước véc-tơ hóa. Trong mã MATLAB của đồ án, tensor không được véc-tơ hóa mà được giữ dưới dạng mảng bốn chiều, nên chương trình dùng tích ngoài `outer4(...)`; về bản chất toán học, đây là cùng phép ghép với tích Kronecker sau khi véc-tơ hóa. Phép nhân này không phải một bước thêm tùy ý mà xuất phát trực tiếp từ cấu trúc tách biến của mô hình kênh.
