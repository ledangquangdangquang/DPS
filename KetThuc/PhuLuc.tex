...
Các thí nghiệm quét dùng cấu hình không gian--thời gian giống cấu hình chính nhưng thay đổi số MPC. Bảng~\ref{tab:app_experiment_parameters} ghi rõ số hiện thực và cách đo thời gian để phân biệt dữ liệu ngẫu nhiên với phép đo hiệu năng.

\begin{table}[H]
    \centering
    \small
    \caption{Cấu hình thí nghiệm quét số MPC}
...
\subsection*{A4. Kết quả thô}
\phantomsection
\addcontentsline{toc}{subsection}{A4. Kết quả thô}
...
Tệp đầy đủ được lưu cùng mã nguồn đồ án. Đoạn dưới đây trích phần đầu của tệp để thể hiện tên cột, thứ tự bản ghi và độ chính xác số được lưu; các bảng tổng hợp trong Chương 4 được tính từ các bản ghi này.
